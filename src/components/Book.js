...
const Book = ({ book }) => {
  ...
  return (
    <div className="book">
      <a target="_blank" href={book.volumeInfo.previewLink}><h2>{title ? title : 'No title available'}</h2></a>  // Display title if available, otherwise display 'No title available'
